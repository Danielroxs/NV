...
const ProfileCard = () => {
  ...
  return (
    <div className="flex justify-center items-center bg-gray-100 p-4">
      <div
        className="w-full max-w-xs sm:w-64 relative cursor-pointer group"
        onClick={toggleDetails}
      >
        <div className="w-full h-full rounded-full overflow-hidden border-4 border-indigo-500 shadow-lg transition-transform duration-300 transform group-hover:scale-105">
          {/* Ajuste de proporciones con aspect ratio */}
